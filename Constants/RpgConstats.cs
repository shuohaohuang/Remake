namespace RpgConstants
{
    public  class RpgConstant
    {
       public const string MenuMsg = "1. Start a new game" +
        ...
        ZeroStr = "0", OneStr = "1", TwoStr = "2", ThreeStr = "3", FourStr = "4";

        public const int Zero = 0, One = 1, Two = 2, Three = 3, Four = 4, SkillCd = 5, CriticalProbability = 10, FailedAttackProbabilitty = 50;

        public const float ArcherMinHp = 1000f, ArcherMinAttack = 200f, ArcherMinReduction = 25f,
